...
The quickest way to get up and running with Jasper is to download the pre-compiled disk image [available here](http://sourceforge.net/projects/keithby/files/jasper-disk-image.tar.gz/download). After imaging your SD card, skip to the section on [configuring your Jasper Client](#configure-jasper).
...
{% highlight bash %}
git clone https://github.com/keithby/jasper-client.git jasper
{% endhighlight %}
